...
```bash
kubectl apply -f /Users/linhlam/Documents/Demo/AMP/prometheus-daemonset.yml
```
...
```bash
helm3 upgrade -i kubecost oci://public.ecr.aws/kubecost/cost-analyzer --version 1.99.0 \
--namespace kubecost --create-namespace \
